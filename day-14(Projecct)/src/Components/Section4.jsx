...
const Section4 = () => {
  return (
    <>
    <section className="ftco-section ftco-causes ftco-no-pb" id="causes-section">
<div className="container">
<div className="row justify-content-center pb-5">
<div className="col-md-12 heading-section text-center ftco-animate">
<span className="subheading">Donate Charity</span>
<h2 className="mb-5">Causes Needs Our Help</h2>
...
<div className="icon">
<span className="flaticon-church"></span>
</div>
</div>
<div className="col-md-10 daily-verse pl-md-5 ftco-animate">
<span className="subheading">Jesus Christ Said:</span>
...
<h4 className="h5 mt-4 font-weight-bold"><span>Bible:</span> John 3:16 KJV</h4>
</div>
</div>
</div>
</div>
...
<h2 className="mb-4">Read the Latest Blog</h2>
<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
</div>
</div>
...
<section className="ftco-section ftco-no-pb" id="pastor-section">
<div className="container">
<div className="row justify-content-center pb-5">
<div className="col-md-6 heading-section text-center ftco-animate">
<span className="subheading">Pastors</span>
<h2 className="mb-4">Church Pastor</h2>
<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
</div>
</div>
<div className="row">
...
<h2 className="mb-1">Christian Church Photo Gallery</h2>
</div>
</div>
<div className="row">
